...
def welcome_tertulia_page(request):
    ...
    print(student_tertulia_name)


    tertulia = Tertulia.objects.get(tertulia_name=student.tertulia_name)
    print(tertulia)
    ...
    #return tertulia.tertulia_lugares
    #print(tertulia.tertulia_lugares)
